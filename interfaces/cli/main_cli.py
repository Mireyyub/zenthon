...
def parse_args():
    ...
    self_sub.add_parser("body")
    self_sub.add_parser("status")
    self_sub.add_parser("map")
    sc = self_sub.add_parser("cell")
    sc.add_argument("--name", default="brain")
    sr = self_sub.add_parser("read")
    sr.add_argument("--path", required=True)
    sr.add_argument("--start", type=int, default=1)
    sr.add_argument("--end", type=int, default=None)
    sr.add_argument("--max-lines", type=int, default=200)
    ss = self_sub.add_parser("symbols")
    ss.add_argument("--path", required=True)
    ssearch = self_sub.add_parser("search")
    ssearch.add_argument("--query", required=True)
    ssearch.add_argument("--prefix", default="")
    smu = self_sub.add_parser("mutable")
    smu.add_argument("--path", required=True)
